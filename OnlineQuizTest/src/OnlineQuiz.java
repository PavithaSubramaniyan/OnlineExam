...
{  
    ...
    JButton b1,b2,b3;  
    ButtonGroup bg;  
    int count=0,current=0,x=1,y=1,now=0,showanswer=0;  
    int m[]=new int[10];      
    OnlineQuiz(String s)  
    {  
        super(s);  
    ...
    {  
        ...
        if(e.getActionCommand().equals("Show Answer"))  
        {  
            if(checking())  
                count=count+1;  
            now=current;  
    ...
    {  
        new OnlineQuiz("Online Test Of Java");  
    }  
}  
